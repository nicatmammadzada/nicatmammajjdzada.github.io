                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body" style="display: block;">
                            ...
                            <form action="{{route('admin.product.promokod',$product->id)}}"
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Endirim (%-lə):</label>
                                        <div class="col-lg-4">
                                            <input type="number" class="form-control" name="faiz"
                                                 placeholder="10"  value="{{old('faiz')}}">
                                        </div>
                                    </div>
                        ...
                        @if($product->promos->count()>0)
                            <table class="table datatable-responsive-row-control">
                                ...
                                @foreach($product->promos as $key=>$promo)
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td>
                                            {{$promo->code ?? ''}}
                                        ...
                                        <td>
                                            <a  class="btn btn-danger"  onclick='checkDeleteConfrim("{{route('admin.product.promoDestroy',$promo->id)}}")'><i
