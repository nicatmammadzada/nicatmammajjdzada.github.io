                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body" style="display: block;">
                            <div class="panel-heading">
                                ...
                                <div class="heading-elements">
                                    <a href="{{route('admin.project.index')}}"><span
                                            class="label label-success">Layihelere QAYIT</span></a>
                                </div>
                            </div>

                            <form action="{{route('admin.project.update',$product->id)}}" class="form-horizontal"
                                  method="Post"
