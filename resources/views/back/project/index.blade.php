    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <a href="{{route('admin.project.create')}}"><span
                        class="label label-success">YENİ project</span></a>
            </div>
        </div>
            ...
            @if($professions->count()>0)
                @foreach($professions as $key=>$profession)
                    <tr {{session()->has('id') &&  $profession->id==session('id') ? 'style=background:#38d28f;' : ''}} >
                        ...
                        <td><a class="btn btn-success" href="{{route('admin.project.edit',$profession->id)}}">edit</a></td>
