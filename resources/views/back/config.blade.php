...
{{--                        </div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="thumbnail" style="width: 30%">
                                    <div class="thumb" style="background: #5594c0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="file" name="logo" id="productPhoto" class="form-control" >
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Logo For Footer:</label>
                            <div class="col-lg-9">
                                <div class="thumbnail" style="width: 30%">
                                    <div class="thumb">
                                        <img src="{{asset("uploads/photo").'/'.$config->logo1 ?? ''}}" alt="">
                                        <div class="caption-overflow">
										<span>
											<a href="{{asset("uploads/photo").'/'.$config->logo1 ?? ''}}" data-popup="lightbox" rel="gallery" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-plus3"></i></a>
										</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-3 control-label"></label>
                            <div class="col-lg-9">
                                <input type="file" name="logo1" id="productPhoto" class="form-control" >
                                <span class="help-block">Qəbul edilən uzantılar: gif, png, jpg, jpeg. Maksimum həcm 500 kb olmalıdır.</span>
                            </div>
                        </div>
